...
public class ApplyMobileNeural implements Runnable {
    ...
    public static void main(String [] args) throws IOException{
        ...
        int countrow=0;
        try {
            BufferedReader reader = new BufferedReader(new FileReader("/Users/yujingxie/Desktop/TtrainWs.csv"));
           // reader.readLine();
            String line = "";
        ...
        int count=0;
        try {
            BufferedReader reader = new BufferedReader(new FileReader("/Users/yujingxie/Desktop/TrainTargetWs.csv"));
            String line = "";
            while((line=reader.readLine())!=null){
                String item[] = line.split("，");
        ...
        int countrow1=0;
        try {
            BufferedReader reader = new BufferedReader(new FileReader("/Users/yujingxie/Desktop/TestWs.csv"));
            // reader.readLine();
            String line = "";
            while((line=reader.readLine())!=null){
                String item[] = line.split("，");
        ...
        int count2=0;
        try {
            BufferedReader reader = new BufferedReader(new FileReader("/Users/yujingxie/Desktop/TestTargetWs.csv"));
            String line = "";
            while((line=reader.readLine())!=null){
                String item[] = line.split("，");
        ...
        ApplyMobileNeural apply=new ApplyMobileNeural(traindata,targetdata,testdata,testtarget,15);
