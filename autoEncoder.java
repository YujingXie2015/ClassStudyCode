...
public class autoEncoder {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < 10; i++) {
            NeutralNetwork neutral = new NeutralNetwork(100, 100, 100);
            neutral.generateInput();
            trainError[i] = neutral.neuralLearning(100, 0.1, 0.001);
            neutral.generateTestdata();
            testError[i] = neutral.testNeuralNetwork();
            if(i==5) {
                neutral.writeFile(neutral.w1, "w1au");
                neutral.writeFile(neutral.w2,"w2au");
            }
        }
